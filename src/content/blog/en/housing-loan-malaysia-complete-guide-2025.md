---
title: "Pinjaman Rumah Malaysia 2025: CTOS Teruk? Panduan Lengkap Lulus 90% (RM300K-RM1.5M)"
slug: "housing-loan-malaysia-complete-guide-2025"
description: "🏠 TERBUKTI LULUS! Cara apply pinjaman rumah walaupun CTOS/CCRIS teruk. Panduan lengkap DSR, kadar faedah 3.5-4.5%, down payment, dokumen. First-time buyer WAJIB baca! Gaji RM3K pun boleh!"
author: "MyPinjam Credit Team"
publishedDate: "2025-01-18"
modifiedDate: "2025-01-18"
category: "Property Financing"
tags: ["housing loan", "home loan", "property financing", "malaysia", "first time buyer", "pinjaman rumah", "房屋贷款", "வீட்டுக்கடன்", "mortgage", "bank loan", "islamic financing", "bumiputera", "CTOS", "CCRIS"]
image: "/blog/housing-loan-guide.jpg"
featured: true
...
- ✅ EA form or LHDN tax assessment
...
- ✅ Form B/BE tax returns (last 2 years)
- ✅ Business invoices and proof
...
**Formula:**
```
DSR = (Monthly Debt Obligations ÷ Gross Monthly Income) × 100
```
...
Maximum total debt = RM8,000 × 70% = RM5,600
...
**Second Property:**
- Property value ≤ RM600,000: **20% down payment** (80% financing)
...
**Result**:
✅ **Approved RM380,000 at 4.35% for 35 years**
✅ Monthly payment: RM1,645
✅ Total cash needed: Only RM12,000 (legal fees + stamp duty)
✅ Moved into first home within 4 months
...
**Result**:
✅ **Approved RM520,000 at 4.50% for 30 years**
✅ Monthly payment: RM2,635
✅ Combined DSR: 52% (well within limit)
✅ Used business profits for renovation
...
1. ✅ Settled personal loan completely (RM15,000 lump sum payment)
2. ✅ Reduced credit card balance from RM12,000 to RM2,000
3. ✅ Got promotion with RM500 salary increase (now RM6,500)
4. ✅ Applied to different bank with better DSR calculation
...
**Result**:
✅ **Approved RM405,000 at 4.40% for 30 years**
✅ Monthly payment: RM2,048
✅ New DSR: 58% [(RM1,200 car + RM300 card + RM2,048 housing) / RM6,500]
...
**How to Avoid**:
- ✅ Compare at least 3-5 banks
- ✅ Use loan comparison websites
- ✅ Consult with licensed loan agent (free service)
- ✅ Check if your employer has corporate banking benefits
...
**How to Avoid**:
- ✅ Calculate all monthly expenses first
- ✅ Keep housing payment ≤ 30% of gross income
- ✅ Maintain 20% savings rate after all expenses
- ✅ Account for future children, career changes
...
- ✅ Ask lawyer to explain every clause
- ✅ Specifically ask about: lock-in, penalties, insurance requirements
- ✅ Get written confirmation of verbal promises
- ✅ Compare penalty clauses across banks
...
**How to Avoid**:
- ✅ Budget 13-15% of property price for all costs
- ✅ Keep separate "house fund" for ongoing costs
...
Rental income ≥ 80% of monthly payment
OR
Don't buy if you can't comfortably carry it
```

**How to Avoid**:
- ✅ Research actual rental rates in area
- ✅ Calculate realistic appreciation (3-5% annually, not 20%!)
- ✅ Account for vacancy periods (2-3 months/year)
- ✅ Consider tenancy issues, maintenance costs
- ✅ Only invest with surplus money, not by stretching
...
**How to Avoid**:
- ✅ Always get MRTA (Mortgage Reducing Term Assurance) minimum
- ✅ Consider MLTA if you want cash payout + loan settlement
- ✅ Shop around - can buy from different insurers (cheaper than bank's)
- ✅ Calculate if term life insurance + savings plan better than MRTA
- ✅ Don't skip this to save few thousand
...
❌ Fixed period usually 2-5 years only
...
- Total property value ≤ 3-4 times annual income
...
- WhatsApp us at [+60 16-747 9368](https://wa.me/60167479368)
...
✅ **Licensed & Registered** - SSM 1404850-H
...
📞 **WhatsApp**: [+60 16-747 9368](https://wa.me/60167479368)
💻 **Apply Online**: [www.mypinjamcredit.com](/)
📧 **Email**: hello@mypinjamcredit.com
📍 **Office**: Mont Kiara, Kuala Lumpur
